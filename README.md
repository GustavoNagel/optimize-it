...
- [`Stale bot`](https://github.com/apps/stale) that closes abandoned issues after a period of inactivity. (You will only [need to setup free plan](https://github.com/marketplace/stale)). Configuration is [here](https://github.com/optimize_it/optimize-it/blob/master/.github/.stale.yml).
...
You can update it in [`release-drafter.yml`](https://github.com/optimize_it/optimize-it/blob/master/.github/release-drafter.yml).
...
This project is licensed under the terms of the `MIT` license. See [LICENSE](https://github.com/optimize_it/optimize-it/blob/master/LICENSE) for more details.
...
@misc{optimize-it,
  author = {optimize-it},
  title = {Awesome `optimize-it` is a Python cli/package with optimization tools},
  year = {2023},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/optimize_it/optimize-it}}
}
```
